...
#
#   File: findORFs.py 
#   One fasta execution: python findORFs.py -lG -s "ATG" -mG 100< SARSCov2Wuhan.fa > sars2.bed
#                        python findORFs.py -lG -s "ATG" -mG 100< ratG13.fa > ratG13.bed                
#                        python findORFs.py -lG -s "ATG" -mG 100< coronavirusUrbani.fa > coronovirusUrbani.bed
            ...
            for header, sequence in fastaFile.readFasta():
                ...
                for orf in framesList:
                    ...
                    if orf[3] >= myCommandLine.args.minGene:
                        sys.stdout.write('{} {:>5d} {:>5d} {:>5d} ORF {:+d}\n'.format(newHeader, orf[1], orf[2], orf[3], orf[0]))
    else:
